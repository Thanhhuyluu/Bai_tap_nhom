    ...
    <div class="container">
        ...
        <div class="search-container">
		    ...
		    <select class="location-select">
		        <option value="-1" disabled selected>Chọn địa điểm</option>
		        <%

		        if(khuVucList == null) khuVucList = new ArrayList();
		        for(KhuVuc k : khuVucList) {
		        %>
		        
		        <option value=""><%=k.getTenKhuVuc() %></option>
                ...
                <tr> 
                    ...
                    <td>
                        <span class="action-icons">
                            ...
                            <a href="#" class="action-icon-link"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="#" class="action-icon-link"><i class="fa-solid fa-trash"></i></a>
                        </span>
                    </td>
                </tr>
            	<%} %>
